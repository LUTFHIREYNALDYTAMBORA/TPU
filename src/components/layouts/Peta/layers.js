...
export const ListLayers = [
  ...
  },
  {
    ...
    title: 'Satellite',
    url: 'https://api.maptiler.com/maps/satellite/256/{z}/{x}/{y}.jpg?key=gs3svoCS6YyryTZJJAm0'
  },
  {
  ...
  },
  {
    ...
    title: 'Outdoor',
    url: 'https://api.maptiler.com/maps/outdoor-v2/256/{z}/{x}/{y}.png?key=gs3svoCS6YyryTZJJAm0'
  },
  {
    pic: <Image alt="" src={backdrop} width={70} />,
    title: 'Backdrop',
    url: 'https://api.maptiler.com/maps/backdrop/256/{z}/{x}/{y}.png?key=gs3svoCS6YyryTZJJAm0'
  },
];
